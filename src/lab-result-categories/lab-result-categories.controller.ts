...
export class LabResultCategoriesController {
  constructor(private readonly labResultCategoriesService: LabResultCategoriesService) {}
  ...
  @UseGuards(JwtAuthGuard, RoleGuard)
  @Patch(':id')
  update(@Param('id') id: number, @Body() updateLabResultCategoryDto: UpdateLabResultCategoryDto) {
    return this.labResultCategoriesService.update(id, updateLabResultCategoryDto);
  }
